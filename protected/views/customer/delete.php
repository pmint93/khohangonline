<?php
$THISPAGE = Yii::app()->getBaseUrl(true) . "/customer/delete";
...
if ($renderForm) {
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form name="deletecustomer-form" class="form-horizontal" role="form" method="post">
                <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                        <input type="hidden" name="submited">
                        <button class="btn btn-danger" type="button"
                                onclick="javascript: document.forms['deletecustomer-form'].submit()">
                            <i class="icon-bolt bigger-110"></i>
                            Xóa
                        </button>
                        &nbsp; &nbsp; &nbsp;
                        <a href="<?php echo Yii::app()->getBaseUrl(true); ?>/customer" class="btn">
