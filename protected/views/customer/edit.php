<?php
$THISPAGE = Yii::app()->getBaseUrl(true) . "/customer/edit";
...
if ($renderForm) {
    ...
    <form name="editcustomer-form" class="form-horizontal" role="form" method="post">
        ...
        <div class="clearfix form-actions">
            <div class="col-md-offset-3 col-md-9">
                ...
                <button class="btn btn-info" type="button"
                        onclick="javascript: document.forms['editcustomer-form'].submit()">
