...
<div class="row">
    <div class="col-xs-12">
        ...
        <form name="delivery-form" class="form-horizontal" method="post" onsubmit="return false;">
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="provider">Đối tác/Khách hàng</label>
                    ...
                    <select id="provider" name="provider" class="select2" data-placeholder="Nhấn vào để chọn...">
                        ...
                        foreach ($customers as $customer) {
                            echo '<option
                                ...
                                value="' . $customer['id'] . '" '
                                . ((isset($default['customer_id']) && $default['customer_id'] == $customer['customer_id']) ? 'selected' : '') . '>'
                    ...
                    <div class="clearfix">
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="lighter">
                                    <i class="icon-info-sign"></i>Chi tiết hàng xuất</h4>
                            </div>
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <button class="btn btn-info" type="button"
                            onclick="javascript: document.forms['delivery-form'].submit()">
