...
<div class="row">
    ...
    <div class="col-xs-12">
        ...
        if (!isset($rows) || count($rows) <= 0) {
            echo '<div class="table-header">Chưa có sản phẩm nào</div>';
        } else {
                ...
                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                    ...
                    foreach ($rows as $i => $row) {
                        ...
                        <tr>
                            ...
                            <td title="<?php echo $row["category_description"]; ?>"><?php echo $row["category_name"]; ?></td>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="<?php echo Yii::app()->getBaseUrl(true)."/product/edit/".$row["id"] ?>" title="Sửa">
                                        <i class="icon-pencil bigger-130"></i>
                                    </a>

                                    <a class="red" href="<?php echo Yii::app()->getBaseUrl(true)."/product/delete/".$row["id"] ?>" title="Xóa">
                                ...
                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                    <div class="inline position-relative">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                            ...
                                            <li title="Sửa">
                                                <a href="<?php echo Yii::app()->getBaseUrl(true)."/product/edit/".$row["id"] ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                    <span class="green">
                                            ...
                                            <li title="Xóa">
                                                <a href="<?php echo Yii::app()->getBaseUrl(true)."/product/delete/".$row["id"] ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                    <span class="red">
...
<script type="text/javascript">
    ...
    function deleteSelected(){
        ...
        if(checkedIds.length){
            if(!confirm("Xóa tất cả sản phẩm đã chọn ?")) return;
            $.ajax({
                url: "<?php echo Yii::app()->getBaseUrl(true)."/product/deleteAll"; ?>",
                method: "POST",
                data: {
                    ids: checkedIds
                },
    ...
    function EBE(){
        EBExport({
            ...
            onComplete: function(excel){
                ...
                a.setAttribute('download', "San pham.xlsx");
